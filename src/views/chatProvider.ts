...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .tool-card .ticon { margin-right: 4px; }
    .tool-card .tname { font-weight: 600; }
    .tool-card .tstatus { color: var(--vsh-muted); }
    .tool-card.failed { border-left-color: var(--vsh-error); }
    .tool-card.failed .tstatus { color: var(--vsh-error); font-weight: 600; }
    .tool-card .terr { display: block; margin-top: 4px; font-size: 11px; color: var(--vsh-error); white-space: pre-wrap; word-break: break-word; }
